...
Highcharts.chart('example7', {
  ...
  title: {
    floating: true,
    align: 'center',
    text: '<b>Number of people unable to keep home adequately warm<br/> in Europe, 2005-2020</b>'
  },

  tooltip: {
    useHTML: true,
    pointFormat: '<b>Country: {series.name}</b><br/>Number of people: {point.y:,.0f}'
  },
